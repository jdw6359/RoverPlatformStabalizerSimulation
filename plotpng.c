...
int main() {
  ...
  fprintf(pipe,"plot ");
  fprintf(pipe,"'ipend.sim' using 1:2 lt 1 lw 4 t 'cart position',");
  fprintf(pipe,"'ipend.sim' using 1:3 lt 2 lw 4 t 'pend angle',");
  fprintf(pipe,"'ipend.sim' using 1:4 lt 3 lw 4 t 'cart velocity',");
